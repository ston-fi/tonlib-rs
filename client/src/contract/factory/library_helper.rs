...
mod tests {
    ...
    fn test_extract_libs_hashes_from_tx() -> anyhow::Result<()> {
        ...
        let hashes = HashSet::from_iter(LibraryHelper::extract_library_hashes(&[tx])?);
