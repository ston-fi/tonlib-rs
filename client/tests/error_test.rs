...
use tonlib_client::client::TonClientError;
use tonlib_client::contract::TonContractError;
use tonlib_client::meta::{IpfsLoaderError, MetaDataContent, MetaLoaderError};
...
fn test_internal_txid_parse_error_output() {
    ...
    log::error!(
        "{}",
        TransactionIdParseError::new("bad txid".to_string(), "bad message".to_string())
    );
}
